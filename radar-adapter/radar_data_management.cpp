...
radarMqttObject json_to_struct(std::string mqtt_radar_object)
{
    ...
    if (!document.HasParseError() && document.IsObject())
    {
        ...
        try {
            ...
            spdlog::error("acceleration get exception");
            obj.acceleration = 0;
        }
        try {
            if (document.HasMember("classification") && document["classification"].IsInt()) {
                ...
                spdlog::error("classification not found");
                return {};
            }
        } catch (std::exception e) {
            spdlog::error("classification get exception");
        ...
        try {
            if (document.HasMember("confidence") && document["confidence"].IsInt()) {
                ...
                spdlog::error("confidence not found");
                return {};
            }
        } catch (std::exception e) {
            spdlog::error("confidence get exception");
            obj.confidence = 0;
        }
        try {
            if (document.HasMember("heading") && document["heading"].IsDouble()) {
                ...
                spdlog::error("heading not found");
                return {};
            }
        } catch (std::exception e) {
            spdlog::error("heading get exception");
            obj.heading = 0;
        }
        try {
            if (document.HasMember("latitude") && document["latitude"].IsDouble()) {
                ...
                spdlog::error("latitude not found");
                return {};
            }
        }
        catch (std::exception e) {
            spdlog::error("latitude get exception");
            obj.latitude = 0;
        }
        try {
            ...
            if (document.HasMember("length") && document["length"].IsDouble()) {
                ...
                spdlog::error("length not found");
                return {};
            }
        }
        catch (std::exception e) {
            spdlog::error("length get exception");
            obj.length = 0;
        }
        try {
            if (document.HasMember("longitude") && document["longitude"].IsDouble()) {
                ...
                spdlog::error("longitude not found");
                return {};
            }
        }
        catch (std::exception e) {
            spdlog::error("longitude get exception");
            obj.longitude = 0;
        }
        try {
            if (document.HasMember("cloudPersist") && document["cloudPersist"].IsBool()) {
                ...
                spdlog::error("cloudPersist not found");
                return {};
            }
        }
        catch (std::exception e) {
            spdlog::error("cloudPersist get exception");
        ...
        try {
            ...
            spdlog::error("objectID get exception");
            obj.objectID = -101;
        }
        try {
            if (document.HasMember("receiverID") && document["receiverID"].IsInt()) {
                ...
                spdlog::error("receiverID not found");
                return {};
            }
        } catch (std::exception e) {
            spdlog::error("receiverID get exception");
            obj.receiverID = -1;
        }
        try {
            ...
            spdlog::error("speed get exception");
            obj.speed = 0;
        }
        ...
        {
            spdlog::error("timestamp not found");
            return {};
        }
        return obj;
    } else {
