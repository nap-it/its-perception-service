...
#define JSONMessage_max_cdr_typesize 20000ULL;
#define JSONMessage_max_key_cdr_typesize 0ULL;
...
size_t JSONMessage::getMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
    return JSONMessage_max_cdr_typesize;
}

size_t JSONMessage::getCdrSerializedSize(
...
size_t JSONMessage::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
    return JSONMessage_max_key_cdr_typesize;
}

bool JSONMessage::isKeyDefined()
{
    return false;
}

void JSONMessage::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
}
