...
#ifndef _FAST_DDS_GENERATED_JSONMESSAGE_H_
#define _FAST_DDS_GENERATED_JSONMESSAGE_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(JSONMESSAGE_SOURCE)
#define JSONMESSAGE_DllAPI __declspec( dllexport )
#else
#define JSONMESSAGE_DllAPI __declspec( dllimport )
#endif // JSONMESSAGE_SOURCE
#else
#define JSONMESSAGE_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define JSONMESSAGE_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure JSONMessage defined by the user in the IDL file.
 * @ingroup JSONMessage
 */
class JSONMessage
{
public:
     ...
     */
    eProsima_user_DllExport JSONMessage();
     ...
     * @param x Reference to the object JSONMessage that will be copied.
     */
    eProsima_user_DllExport JSONMessage(
            const JSONMessage& x);
     ...
     * @param x Reference to the object JSONMessage that will be copied.
     */
    eProsima_user_DllExport JSONMessage& operator =(
            const JSONMessage& x);
     ...
     * @param x JSONMessage object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_JSONMESSAGE_H_
